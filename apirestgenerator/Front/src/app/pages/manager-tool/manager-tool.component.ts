...
@Component({
  selector: 'app-manager-tool',
  templateUrl: './manager-tool.component.html',
  styleUrls: ['./manager-tool.component.css']
})
export class ManagerToolComponent implements OnInit, OnDestroy {
  ...
  constructor(private dialogRef: MatDialogRef<ManagerToolComponent>,
