...
public class ServicesImplimet implements IImportModel {
    ...
    public void startCreacionImplement(ArchivoBaseDatosPojo archivo, Creador creadors) {
        try {
            this.capaPojo = archivo.getCapaPojo();
    ...
    public StringBuilder createImport(String packageNames, String serviceName, String repositorieName, EntidadesPojo entidad) {
        ...
        for (RelacionPojo relacion : entidad.getRelaciones()) {
            ...
            sb.append(BREAK_LINE);
            sb.append(stringEnsamble(List.of("import ", packageNames,".", this.capaPojo.getModelT().trim(),".", relacion.getNameClassRelacion(), this.capaPojo.getModelM(),";",BREAK_LINE)));
    ...
    private StringBuilder createAutowiredMapper(EntidadesPojo entidad) {
    ...
    private String atributoName(List<AtributoPojo> atributoPojos) {
        String atributoName = "";
        for (AtributoPojo atributo : atributoPojos) {
            if (atributo.getsId()) {
    ...
    private StringBuilder ContainingRelacionNoBiDirectional(EntidadesPojo entidad, String repositorieNameOjecte, String entidadNombre, CapaPojo capaPojo) {
        ...
        for (RelacionPojo relacion : entidad.getRelaciones()) {
            ...
            if (relacion.getRelation().equals("ManyToMany") || relacion.getRelation().equals("OneToMany")) {
                ...
                sv.append(stringEnsamble(List.of(DOUBLETAB, DOUBLETAB, "for (", relacion.getNameClassRelacion(),capaPojo.getModelM(), TAB, relacion.getNameRelacion(), "x : ")));
