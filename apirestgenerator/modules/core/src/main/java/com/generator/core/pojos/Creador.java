...
public class Creador {
    ...
    public String directionForJava() {
        String direction = this.path(
               List.of(direccionDeCarpeta + proyectoName,
                        "src",
                        "main",
                        "java"
                        , this.getCom(),
    ...
    public void crearCarpeta() {
        ...
        String lugarCarpeta = this.path(List.of(direccionDeCarpeta + proyectoName));
        String carpetas = this.path(List.of(lugarCarpeta, "src"));
        listaCarpetas.add(carpetas);
        String carpetasa = this.path(List.of(lugarCarpeta, ".mvn"));
        listaCarpetas.add(carpetasa);
        String carpetasb = this.path(List.of(carpetasa, "wrapper"));
        listaCarpetas.add(carpetasb);
        String carpetas2 = this.path(List.of(carpetas, "main"));
        listaCarpetas.add(carpetas2);
        String carpetas3 = this.path(List.of(carpetas, "test"));
        listaCarpetas.add(carpetas3);
        String carpetas4 = this.path(List.of(carpetas3, "java", com, packageNames1, artifact));
        listaCarpetas.add(carpetas4);
        String carpetas5 = this.path(List.of(carpetas2, "java"));
        listaCarpetas.add(carpetas5);
        String carpetas6 = this.path(List.of(carpetas2, "resources"));
        listaCarpetas.add(carpetas6);
        String carpetas7 = this.path(List.of(carpetas5, com, packageNames1, artifact));
        listaCarpetas.add(carpetas7);
        String carpetas8 = this.path(List.of(carpetas6, "static"));
        listaCarpetas.add(carpetas8);
        String carpetas9 = this.path(List.of(carpetas6, "templates"));
