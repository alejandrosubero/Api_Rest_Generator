...
public interface ITemplatePomxml extends IImportModel {

    default ModelOup getTemplate(ArchivoBaseDatosPojo archivo, Creador creador){
        ...
        try {
            ...
            return ModelOup.builder()
                    .nameOfClass("pom.xml")
                    .classInString(new Formatter().simpleFormat(sb.toString()))
                    .directoryForJava(creador.getDireccionDeCarpeta() + archivo.getProyectoName())
                    .build();
        } catch (Exception e) {
            e.printStackTrace();
            return ModelOup.builder().build();
        }
